...
>
> - 기준 브랜치: `dev`
> - 기준 HEAD: `86691fb` — PR #89 / Issue #86 1차 작업 반영 직후
> - 기준일: **2026-09-21**
> - GitHub Issues: **총 43개 / Closed 40개 / Open 3개**
> - 현재 Open: **#13 다국어**, **#69 반응형 UI**, **#86 관리자 사용자 검색 + 문의 발신자 이메일 표시**
> - 문의 DB 저장 · 관리자 문의 탭 · 이용 내역 날짜 필터는 **PR #89로 `dev`에 병합 완료**이며, Issue #86에는 관리자 사용자 검색과 문의 발신자 이메일 표시가 후속 작업으로 남아 있다.
>
...
- #86 날짜 필터 추가 — **PR #89로 `dev`에 반영 완료**
...
| 문의하기 | 사용자 문의 전용 탭 | #86 — PR #89 반영 완료 |
...
| [#86](https://github.com/JHee0209/Washed/issues/86) | 🟡 Open | 관리자 사용자 검색 + 문의 발신자 이메일 표시 |

## #86 상태 주의

Issue #86의 1차 작업(문의 DB 저장 · 관리자 문의 탭 · 이용 내역 날짜 필터)은 **PR #89로 `dev`에 merge 완료**입니다. Issue 자체는 관리자 사용자 검색과 문의 발신자 이메일 표시가 남아 아직 Open 상태입니다.

따라서 발표 시:

- 문의 관리자 연동과 날짜 필터는 **“이미 동작하는 기능”**으로 설명하고
- **“관리자 사용자 검색과 문의 발신자 이메일 표시가 남은 마지막 개선 작업”**
...
## #86 관리자 사용자 검색 · 문의 발신자 이메일 표시

관리자가 사용자 목록에서 원하는 사용자를 검색하고,  
문의 탭에서 발신자 이메일까지 확인할 수 있도록 개선하는 작업입니다.

PR #89로 **이미 `dev`에 반영된 기능**:
...
| [#86](https://github.com/JHee0209/Washed/issues/86) | 🟡 Open | `[feat/ui]` 관리자 사용자 검색 및 문의 발신자 이메일 표시 |
